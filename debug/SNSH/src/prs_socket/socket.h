...
DLL_EXPORT union SOCKET_CREATE {
  int (*socket_bind)(const char *, int, unsigned char, int *, struct sockaddr_in *);
  int (*socket_conn)(const char *, int, unsigned char, int *, struct sockaddr_in *);
};
...
int DLL_EXPORT create_conn(const char *hostname, int port, unsigned char, int *clientfd, struct sockaddr_in *clientaddr);
int DLL_EXPORT create_bind(const char *hostname, int port, unsigned char, int *clientfd, struct sockaddr_in *clientaddr);
